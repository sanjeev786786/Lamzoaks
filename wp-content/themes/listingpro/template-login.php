						...
						<div class="col-md-12">
							<div class="login-form-popup lp-border-radius-8">
								<div class="siginincontainer">
									...
									<form id="lp-login-temp" class="form-horizontal margin-top-30"  method="post">
										<p class="status"></p>
								...
								<div class="siginupcontainer">
									...
									<form id="registertmp" class="form-horizontal margin-top-30"  method="post">
									<p class="status"></p>
										<div class="form-group">
										...
										<?php
											if(!empty($privacy_policy)){
												...
												<div class="checkbox form-group check_policyy termpolicy pull-left termpolicy-wraper">
													...
													<label for="check_policyy"><a target="_blank" href="'.get_the_permalink($privacy_policy).'" class="help" target="_blank">'.esc_html__('I Agree', 'listingpro-plugin').'</a></label>
													<div class="help-text">
