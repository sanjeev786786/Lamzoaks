...
<?php
	...
	if( !empty($latitude) || !empty($longitude) || $map_show=="true" || !empty($gAddress) || !empty($phone) || !empty($website) || $social_show=="true" || !empty($facebook) || !empty($twitter) || !empty($linkedin) || !empty($google_plus) || !empty($youtube) || !empty($instagram) ){
?>
