														...
														<div class="lp-tool-tip-content clearfix">
															<div class="sortbyrated-outer">
																<div class="border-dropdown sortbyrated">
																	...
																	<?php } ?>
																	<?php if($highRatOPT=="1"){ ?>
																		<li id="listingRate"><a href="#" data-value="listing_rate"><?php echo esc_html__( 'Highest Rated', 'listingpro' );?></a></li>
																	<?php } ?>
																	</ul>
																</div>
															</div>
												...
												<?php 
													...
													foreach($locations as $location) {
														...
														foreach ( $sub as $subID ) {
															...
															$subcatsArray[$term->term_id] = $term->name;
															//echo '<option '.$selected.' class="sub_cat" value="'.$term->term_id.'">-&nbsp;&nbsp;'.$term->name.'</option>';
														}
														if(!empty($subcatsArray)){
															asort($subcatsArray);
															foreach($subcatsArray as $subcatid=>$singlesubcatname){
																echo '<option '.$selected.' class="sub_cat" value="'.$subcatid.'">-&nbsp;&nbsp;'.$singlesubcatname.'</option>';
															}
														}
													}		
												?>	
