	...
	<div class="aligncenter">
		<div class="lp-flip">
			<div class="lp-card">
					...
					<?php if( (!empty($publisedPosts))&& ($wp_query->have_posts()) ){ ?>
											...
											<li class="col-md-1 col-xs-12 lp-promote-ad-image">
												...
												<div class="lp-list-view-content-upper lp-list-view-content-bottom">
													...
													<div class="promote-btn pull-right">
														<input type="submit" name="promote_submit" id="lp-front" class="lp-promotebtn btn btn-first-hover" data-listingtitle="'.$listingtitle.'" data-listingnid="'.$curlistingid.'"  value="'.esc_html__('Promote','listingpro').'"/>
