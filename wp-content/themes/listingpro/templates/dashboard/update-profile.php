										...
										<div class="page-innner-container padding-40 lp-border lp-border-radius-8">
											...
											<div class="form-group">
												<div class="col-sm-6">
													...
													<input value="<?php echo esc_attr($user_email); ?>" type="email" class="form-control" name="email" id="email" placeholder="<?php esc_html_e('eg. example@gmal.com','listingpro'); ?>" />
												</div>
												<div class="col-sm-6">
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<textarea  class="form-control" name="address" id="about" rows="3" placeholder="<?php esc_html_e('Your Address','listingpro'); ?>"><?php echo esc_html($user_address); ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<div class="col-sm-12">
