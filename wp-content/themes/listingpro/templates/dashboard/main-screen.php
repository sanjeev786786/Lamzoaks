		...
		<?php if($publish_listings != 0){ ?>
			<div class="notice info">
				...
				<div class="notice-text">
					...
					<p><?php esc_html_e('Start advertising today and reach 10x more audience which can increase the potential of getting up to 10x leads and double the conversions.','listingpro'); ?></p>
				</div>
			...
			<div class="col-md-4 col-xs-12">
				<div class="count-box blue-box">
					...
					<div class="dash-right-area">
						...
						?>
						<h3><span><?php esc_html_e('Total Views','listingpro'); ?></span> <p class="views"><?php echo $totalViews; ?></p></h3>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-xs-12">
				<div class="count-box orange-box">
					...
					<div class="dash-right-area">
						...
						?>
						<h3><span><?php esc_html_e('Total Leads','listingpro'); ?></span> <p class="views"><?php echo $leadsCount; ?></p></h3>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-xs-12">
				<div class="count-box green-box">
					...
					<div class="dash-right-area">
						...
						?>
						<h3><span><?php esc_html_e('Total Reviews','listingpro'); ?></span> <p class="views"><?php echo $totalReviews; ?></p></h3>
					</div>
				</div>
			</div>
		</div>
						...
						if($rating <= 3){
							echo '
								<li>
									...
									<span><span class="author-name">'.$author.'</span> '.esc_html__('left','listingpro').' '.$rating.'/5 '.esc_html__('rating','listingpro').'</span>
